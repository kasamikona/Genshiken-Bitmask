...
echo "a=/tmp/genshiken;b=\$a/intro.tar.gz;echo Unpacking to \$a;mkdir \$a;tail -n+2 \$0>\$b;tar xzvf \$b -C \$a;echo;cd \$a;${PYTHON:=\"python\"} bitmask.py \$1;echo Cleaning up \$a;cd ..;rm -rf \$a;exit" > $dest/intro.sh
