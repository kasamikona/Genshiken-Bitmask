...
echo "a=/tmp/genshiken;b=\$a/intro.tar.gz;echo Unpacking to \$a;mkdir \$a;tail -n+2 \$0>\$b;tar xzvf \$b -C \$a 2>/dev/null;echo;${PYTHON:=\"python\"} \$a/bitmask.py \$1;echo Cleaning up \$a;rm -rf \$a;exit" > $dest/intro.sh
